...
### Code:
#### unpolar_rgb.m/untitled2.m/AOP_DOP_new.m: Stokes parameter image computation in MATLAB, with input consisting of four images at different polarization angles. Specific differences are detailed in the code.
